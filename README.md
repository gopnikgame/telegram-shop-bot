...
- 🔄 [Руководство по обновлению](docs/UPDATE_GUIDE.md)
- 🔧 [Исправление миграций](docs/MIGRATION_FIX.md)
- 🚀 [Быстрый старт для разработчиков](docs/GETTING_STARTED.md)
- 🎨 [Настройка главного меню](docs/MENU_CONFIGURATION.md)
...
**Рекомендуемый способ (через менеджер):**
