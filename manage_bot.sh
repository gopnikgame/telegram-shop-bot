...
main_menu() {
    while true; do
        ...
        echo "  10. Показать все логи"
        echo "  11. Показать логи API"
        echo "  12. Показать логи PostgreSQL"
        echo "  13. Показать только ошибки"
        echo "  14. Отслеживать логи (follow)"
        echo "  15. Проверить статус системы"
        echo ""
        log "GREEN" "🔧 Обслуживание:"
        echo "  16. Обновить из репозитория"
        echo "  17. Очистка (логи, бэкапы, Docker)"
        echo ""
        log "GREEN" "0. 🚪 Выйти"
        echo ""
